<template>
  <v-container fluid class="ma-0 pa-0">
    <v-parallax class="ma-0 pa-0" height="900" src="/images/dashboard.jpg">
      <v-row center >
        <v-col class="col-md-6 offset-md-3 pt-10" cols="12" sm="6">
          <!-- {{ errors }} -->
          <strong class="ma-2 pa-2 mt-10 pt-10 text-h6">index</strong>
...
export default {
  ...
  methods: {
   async  loginwithgoogle(){
          try {
            let res = await this.$auth.loginWith('google', { params: { prompt: "select_account" } })
