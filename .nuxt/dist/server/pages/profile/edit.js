...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/profile/edit.vue?vue&type=template&id=6d65363c&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-container',[_c('v-row',{attrs:{"align":"center"}},[_c('v-col',{attrs:{"lg":"12"}},[_c('v-card',{staticClass:"  pa-4 ma-4"},[_c('input',{ref:"file",attrs:{"type":"file","id":"file"},on:{"change":function($event){return _vm.handleFileUpload()}}}),_vm._v(" "),_c('v-card',[(_vm.image_preview)?_c('v-img',{attrs:{"src":_vm.image_preview}}):_c('div',[(_vm.form_image)?_c('v-img',{attrs:{"src":_vm.form_image}}):_vm._e()],1)],1),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Name"},model:{value:(_vm.profile.name),callback:function ($$v) {_vm.$set(_vm.profile, "name", $$v)},expression:"profile.name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Username"},model:{value:(_vm.profile['details'].username),callback:function ($$v) {_vm.$set(_vm.profile['details'], "username", $$v)},expression:"profile['details'].username"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"House number"},model:{value:(_vm.profile['details'].house_number),callback:function ($$v) {_vm.$set(_vm.profile['details'], "house_number", $$v)},expression:"profile['details'].house_number"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"City"},model:{value:(_vm.profile['details'].city),callback:function ($$v) {_vm.$set(_vm.profile['details'], "city", $$v)},expression:"profile['details'].city"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Street"},model:{value:(_vm.profile['details'].street),callback:function ($$v) {_vm.$set(_vm.profile['details'], "street", $$v)},expression:"profile['details'].street"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Province"},model:{value:(_vm.profile['details'].province),callback:function ($$v) {_vm.$set(_vm.profile['details'], "province", $$v)},expression:"profile['details'].province"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Country"},model:{value:(_vm.profile['details'].country),callback:function ($$v) {_vm.$set(_vm.profile['details'], "country", $$v)},expression:"profile['details'].country"}}),_vm._v(" "),_c('v-btn',{on:{"click":_vm.Update_Profile}},[_vm._v(" Save ")])],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/profile/edit.vue?vue&type=template&id=6d65363c&scoped=true&
...
var editvue_type_script_lang_js_ = __webpack_require__(283);
